...
import static com.nature.nlm.validation.core.Constants.TEMP_FOLDER;
...
public final class Util {
     ...
     * @return
     */
    public static String getSchematronTransformMD5() {

        final String key = "NLM-Service/Schematron/transform" + "AA-BB-CC";
    ...
    public static boolean notXML(String name) {
        String XML_FILE = "([^\\s]+(\\.(?i)(xml|XML))$)";
        Pattern p = Pattern.compile(XML_FILE);
