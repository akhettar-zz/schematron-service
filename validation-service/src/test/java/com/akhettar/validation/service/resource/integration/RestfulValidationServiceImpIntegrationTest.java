...
public class RestfulValidationServiceImpIntegrationTest extends JerseyGuiceTest {
    ...
    private static final String NLM_XML_DIR = "jats-xml/";
    private static final String NLM_ZIP_DIR = "jats-zip/";
    ...
    public void testUploadFileZip() throws Exception {
        ...
        final InputStream stream = this.getClass().getClassLoader().getResourceAsStream(NLM_ZIP_DIR + "jats.zip");
